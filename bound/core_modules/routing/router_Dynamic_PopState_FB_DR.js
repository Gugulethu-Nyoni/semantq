...
//alert("popScope:"+popScope);
//alert("Params in handlerDeclared:"+searchParams);
...
document.addEventListener('click', (event) => {
    ...
    if (targetElement.tagName === 'A' && targetElement.getAttribute('href')) {
        ...
        let targetRoute = targetElement.getAttribute('href');
...
// Output: "?product=shirt&color=blue&newuser&size=m"
        ...
        //alert("here"+targetRoute);
        //alert("Params"+searchParams);
