...
function peg$parse(input, options) {
  ...
  const peg$e52 = peg$literalExpectation("true", false);
  const peg$e53 = peg$literalExpectation("false", false);
  const peg$e54 = peg$literalExpectation("'", false);
  const peg$e55 = peg$classExpectation(["'"], true, false, false);
  const peg$e56 = peg$literalExpectation("?", false);
  const peg$e57 = peg$literalExpectation(":", false);
  const peg$e58 = peg$literalExpectation("@each", false);
  const peg$e59 = peg$literalExpectation("@endeach", false);
  const peg$e60 = peg$literalExpectation("as", false);
  ...
  function peg$f37(head) {    return head;  }
  function peg$f38(left, right) {    return createBinaryExpression(left, "||", right);  }
  function peg$f39(left, right) {    
         return createBinaryExpression(left, "&&", right);
  }
  function peg$f40(left, op, right) {
  ...
  function peg$f44(left, op, right) {    return createBinaryExpression(left, op, right);  }
  function peg$f45(left, op, right) {    return createBinaryExpression(left, op, right);  }
  function peg$f46(left, op, right) {    return createBinaryExpression(left, op, right);  }
  function peg$f47(left, op, right) {    return createBinaryExpression(left, op, right);  }
  function peg$f48(expr) {    return expr;  }
  function peg$f49(callee, args) {
    return createCallExpression(callee, args);
  }
  function peg$f50(argument) {    
  ...
  function peg$f62(params) {    return params || [];  }
  function peg$f63(param) {    return [param];  }
  function peg$f64(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f65(body) {
    if (!body) error('Empty arrow function body');
    return body;
  }
  function peg$f66(body) {    // Add StringLiteral directly
        if (!body) error('Invalid arrow function body');
        return body;
  }
  function peg$f67(startToken, iterable, body) {
    return createEachStatement(iterable, body, startToken);
  }
  function peg$f68(source, item, keyPart) {
  ...
  function peg$f69(identifier, property) {    // to capture property access like item.id
