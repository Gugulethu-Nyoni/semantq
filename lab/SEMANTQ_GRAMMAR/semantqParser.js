...
function peg$parse(input, options) {
  ...
  function peg$f11(attributeName, attributeValue) {
    return {
      start: location().start.offset,
      end: location().end.offset,
      type: "Attribute",
  ...
  function peg$f19(head, param) {    return param;  }
  ...
  function peg$f27(statements) {
    return {
      type: "BlockStatement",
      body: statements
    };
  }
  function peg$f28(expression) {
    return {
      type: "ExpressionStatement",
      expression: expression
    };
  }
  function peg$f29(params, Identifier, parameters) {
    return {
      type: "IIFE",
      start: location().start.offset + 1,
      end: location().end.offset - 1,
  ...
  function peg$f31(startToken, test, consequent, elsePart) {
  ...
  function peg$f36(head) {    return head;  }
  function peg$f37(left, right) {    return createBinaryExpression(left, "||", right);  }
  ...
  function peg$f43(left, op, right) {    return createBinaryExpression(left, op, right);  }
  ...
  function peg$f59(params, body) {
    return createArrowFunction(params, body);
  }
  function peg$f60() {    return [];  }
  function peg$f61(params) {    return params || [];  }
  function peg$f62(param) {    return [param];  }
  function peg$f63(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f64(body) {
    if (!body) error('Empty arrow function body');
    return body;
  }
  function peg$f65(body) {    // Add StringLiteral directly
        if (!body) error('Invalid arrow function body');
        return body;
  }
  function peg$f66(startToken, iterable, body) {
    return createEachStatement(iterable, body, startToken);
  }
  function peg$f67(source, item, keyPart) {
  ...
  function peg$f68(identifier, property) {    // to capture property access like item.id
