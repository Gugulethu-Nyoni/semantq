...
function peg$parse(input, options) {
  ...
  const peg$e11 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"]], false, false, false);
  ...
  const peg$e18 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", ["0", "9"], "-"], false, false, false);
  const peg$e19 = peg$literalExpectation("\"", false);
  const peg$e20 = peg$classExpectation(["\""], true, false, false);
  const peg$e21 = peg$literalExpectation("(", false);
  const peg$e22 = peg$literalExpectation(")", false);
  const peg$e23 = peg$literalExpectation(",", false);
  const peg$e24 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", ["0", "9"]], false, false, false);
  const peg$e25 = peg$literalExpectation("=>", false);
  const peg$e26 = peg$literalExpectation(";", false);
  const peg$e27 = peg$literalExpectation("function", false);
  const peg$e28 = peg$literalExpectation("@if", false);
  const peg$e29 = peg$literalExpectation("@else", false);
  const peg$e30 = peg$literalExpectation("@endif", false);
  ...
  const peg$e57 = peg$literalExpectation("@each", false);
  const peg$e58 = peg$literalExpectation("@endeach", false);
  const peg$e59 = peg$literalExpectation("as", false);
  ...
  function peg$f4(openTag, closeTag) {    // Handle empty elements like <div></div>
         return createElement(openTag.start, closeTag.end, openTag.name, openTag.attributes, []);
  }
  function peg$f5(openTag, inner, closeTag) {    // Normal case with content
  ...
  function peg$f12(attributeName, attributeValue) {
    return {
      start: location().start.offset,
      end: location().end.offset,
      type: "Attribute",
  ...
  function peg$f20(head, param) {    return param;  }
  ...
  function peg$f28(statements) {
    return {
      type: "BlockStatement",
      body: statements
    };
  }
  function peg$f29(expression) {
    return {
      type: "ExpressionStatement",
      expression: expression
    };
  }
  function peg$f30(params, Identifier, parameters) {
    return {
      type: "IIFE",
      start: location().start.offset + 1,
      end: location().end.offset - 1,
  ...
  function peg$f32(startToken, test, consequent, elsePart) {
  ...
  function peg$f38(head, prop) {    return prop;  }
  function peg$f39(head, tail) {
    return tail.reduce((acc, property) => {
      return createMemberExpression(acc, property);
    }, head);
  }
  function peg$f40(head) {    return head;  }
  function peg$f41(left, right) {    return createBinaryExpression(left, "||", right);  }
  function peg$f42(left, right) {    
         return createBinaryExpression(left, "&&", right);
  }
  function peg$f43(left, op, right) {
    return createBinaryExpression(left, op, right);
  }
  function peg$f44(expr) {    return expr;  }
  function peg$f45(expr) {    return expr;  }
  function peg$f46(expr) {    return expr;  }
  function peg$f47(left, op, right) {    return createBinaryExpression(left, op, right);  }
  function peg$f48(left, op, right) {    return createBinaryExpression(left, op, right);  }
  ...
  function peg$f52(callee, args) {
    return createCallExpression(callee, args);
  }
  function peg$f53(argument) {    
  ...
  function peg$f63(params, body) {
    return createArrowFunction(params, body);
  }
  function peg$f64() {    return [];  }
  function peg$f65(params) {    return params || [];  }
  function peg$f66(param) {    return [param];  }
  ...
  function peg$f69(body) {    // Add StringLiteral directly
        if (!body) error('Invalid arrow function body');
        return body;
  }
  function peg$f70(startToken, iterable, body) {
    return createEachStatement(iterable, body, startToken);
  }
  function peg$f71(source, item, keyPart) {
  ...
  function peg$f72(identifier, property) {    // to capture property access like item.id
