...
function peg$parse(input, options) {
  ...
  const peg$c63 = "false";
  const peg$c64 = "null";
  const peg$c65 = "undefined";
  const peg$c66 = "@each";
  const peg$c67 = "@endeach";
  const peg$c68 = "as";
  ...
  const peg$e15 = peg$otherExpectation("two-way binding attribute");
  const peg$e16 = peg$literalExpectation("bind:", false);
  ...
  const peg$e41 = peg$otherExpectation("arrow function attribute value");
  const peg$e42 = peg$literalExpectation(";", false);
  const peg$e43 = peg$literalExpectation("function", false);
  const peg$e44 = peg$literalExpectation("@if", false);
  const peg$e45 = peg$literalExpectation("@else", false);
  const peg$e46 = peg$literalExpectation("@endif", false);
  const peg$e47 = peg$classExpectation([["a", "z"], "-"], false, false, false);
  ...
  const peg$e52 = peg$literalExpectation("</pre>", false);
  const peg$e53 = peg$literalExpectation("<pre", false);
  ...
  const peg$e87 = peg$literalExpectation("null", false);
  const peg$e88 = peg$literalExpectation("undefined", false);
  const peg$e89 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, false, false);
  const peg$e90 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_"], false, false, false);
  const peg$e91 = peg$literalExpectation("@each", false);
  const peg$e92 = peg$literalExpectation("@endeach", false);
  ...
  function peg$f0(text) {
    return {
      ...
      raw: text, // Add a raw value for debugging/preservation
  ...
  function peg$f11(attributes, codeContent) {
  ...
  function peg$f15(propertyName, value) {
  ...
  function peg$f26(head, param) {    return param;  }
  ...
  function peg$f32(left, operator, right) {
    return {
  ...
  function peg$f34(params) {    return params || [];  }
  function peg$f35(param) {    return [param];  }
  function peg$f36(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f37(params, body) {
    return createArrowFunction(params, body);
  }
  function peg$f38(arrowExpr) {
    return {
      type: "MustacheAttribute",
      start: location().start.offset,
      end: location().end.offset,
  ...
  function peg$f39(statements) {
    return {
      type: "BlockStatement",
      body: statements
    };
  }
  function peg$f40(expression) {
    return {
      type: "ExpressionStatement",
      expression: expression
    };
  }
  function peg$f41(params, Identifier, parameters) {
    return {
      type: "IIFE",
      start: location().start.offset + 1,
      end: location().end.offset - 1,
  ...
  function peg$f43(startToken, test, consequent, elsePart) {
  ...
  function peg$f45(content) {
    return content;
  }
  function peg$f46(parts) {
  ...
  function peg$f47(attributes) {
    return Object.assign({}, ...attributes);
  }
  function peg$f48(name, value) {    return { [name]: value };  }
  function peg$f49(name) {    return { [name]: true };  }
  function peg$f50(value) {    return value;  }
  function peg$f51(value) {    return value;  }
  function peg$f52(language, content) {
    return {
      type: "CodeFence",
  ...
  function peg$f53(parts) {
    return parts.flat().filter(Boolean);
  }
  function peg$f54(code) {    return code;  }
  function peg$f55(text) {
    return {
      type: "PreText",
      content: text,
      start: location().start.offset,
  ...
  function peg$f56(attributes, content) {
    return {
      type: "RawHtmlBlock",
      tag: "pre",
      content: content,
  ...
  function peg$f57(text) {    // Removed leading/trailing _ (optional whitespace) as the content itself can include space.
  ...
  function peg$f59(expr) {    // Removed leading and trailing `_`
         return {
           type: 'MustacheTag',
           expression: expr,
           start: location().start,
  ...
  function peg$f61(left, right) {    return createBinaryExpression(left, "||", right);  }
  ...
  function peg$f65(left, op, right) {    return createBinaryExpression(left, op, right);  }
  ...
  function peg$f75(op, argument) {    // <-- Often PrimaryExpression is sufficient
  ...
  function peg$f81(chars) {    // Add action block here
         return createNode('Literal', location().start, location().end, {
           value: chars,
  ...
  function peg$parseContentLine() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseRawHtmlBlock();
    if (s1 === peg$FAILED) {
      s1 = peg$parseCodeFence();
      if (s1 === peg$FAILED) {
        ...
        if (s1 === peg$FAILED) {
          ...
          if (s1 === peg$FAILED) {
            ...
            if (s1 === peg$FAILED) {
              s1 = peg$parseInterpolations();
              if (s1 === peg$FAILED) {
                s1 = peg$parseConsequentContentBlock();
                if (s1 === peg$FAILED) {
  ...
  function peg$parseRawHtmlAttributes() {
    let s0, s1, s2, s3, s4, s5, s6;

    s0 = peg$currPos;
    s1 = peg$currPos;
    s2 = peg$parseRawHtmlAttribute();
    if (s2 !== peg$FAILED) {
      s3 = [];
      s4 = peg$currPos;
      s5 = peg$parse_();
      s6 = peg$parseRawHtmlAttribute();
      if (s6 !== peg$FAILED) {
        s5 = [s5, s6];
        s4 = s5;
      } else {
  ...
  function peg$parseRawHtmlAttribute() {
    let s0, s1, s2, s3, s4, s5;
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        s4 = peg$parse_();
        s5 = peg$parseRawHtmlAttributeValue();
        if (s5 !== peg$FAILED) {
          peg$savedPos = s0;
          s0 = peg$f48(s1, s5);
        } else {
  ...
  function peg$parseRawHtmlAttributeValue() {
    let s0, s1, s2, s3, s4;
  ...
  function peg$parsePreContent() {
    let s0, s1, s2;

    s0 = peg$currPos;
    s1 = [];
    s2 = peg$parseCodeFenceContent();
    if (s2 === peg$FAILED) {
      s2 = peg$parsePreTextContent();
    }
    while (s2 !== peg$FAILED) {
      s1.push(s2);
      s2 = peg$parseCodeFenceContent();
  ...
  function peg$parseCodeFenceContent() {
    let s0, s1;
  ...
  function peg$parsePreTextContent() {
    let s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseRawHtmlBlock() {
    let s0, s1, s2, s3, s4, s5, s6, s7;
  ...
  function peg$parseAtIdentifier() {
    let s0, s1, s2, s3, s4, s5, s6;
  ...
  function peg$parseInterpolations() {
    let s0;
