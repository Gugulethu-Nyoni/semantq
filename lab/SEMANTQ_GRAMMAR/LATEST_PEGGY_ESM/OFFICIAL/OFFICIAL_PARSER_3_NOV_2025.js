...
function peg$parse(input, options) {
  ...
  const peg$e39 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", ["0", "9"]], false, false, false);
  ...
  const peg$e52 = peg$otherExpectation("arrow function attribute value");
  const peg$e53 = peg$literalExpectation(";", false);
  const peg$e54 = peg$literalExpectation("function", false);
  const peg$e55 = peg$literalExpectation("@if", false);
  ...
  const peg$e82 = peg$literalExpectation("typeof", false);
  const peg$e83 = peg$literalExpectation("void", false);
  const peg$e84 = peg$literalExpectation("delete", false);
  ...
  const peg$e88 = peg$literalExpectation("true", false);
  const peg$e89 = peg$literalExpectation("false", false);
  const peg$e90 = peg$literalExpectation("null", false);
  const peg$e91 = peg$literalExpectation("undefined", false);
  const peg$e92 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, false, false);
  const peg$e93 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_"], false, false, false);
  const peg$e94 = peg$literalExpectation("@each", false);
  const peg$e95 = peg$literalExpectation("as", false);
