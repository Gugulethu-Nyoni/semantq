...
function peg$parse(input, options) {
  ...
  const peg$c56 = ".";
  const peg$c57 = "?.";
  const peg$c58 = "typeof";
  const peg$c59 = "void";
  const peg$c60 = "delete";
  const peg$c61 = "'";
  const peg$c62 = "true";
  const peg$c63 = "false";
  const peg$c64 = "null";
  ...
  const peg$r4 = /^[a-zA-Z_0-9\-:]/;
  const peg$r5 = /^[a-zA-Z_\-]/;
  const peg$r6 = /^[^"]/;
  const peg$r7 = /^[a-zA-Z_0-9]/;
  const peg$r8 = /^[^@{}\n<]/;
  const peg$r9 = /^[&\^|]/;
  const peg$r10 = /^[<>]/;
  const peg$r11 = /^[+\-]/;
  ...
  const peg$e13 = peg$otherExpectation("pre block");
  const peg$e14 = peg$literalExpectation("pre", false);
  const peg$e15 = peg$literalExpectation("</pre>", false);
  const peg$e16 = peg$otherExpectation("code block");
  const peg$e17 = peg$literalExpectation("code", false);
  const peg$e18 = peg$literalExpectation("</code>", false);
  const peg$e19 = peg$literalExpectation("=", false);
  const peg$e20 = peg$otherExpectation("two-way binding attribute");
  const peg$e21 = peg$literalExpectation("bind:", false);
  const peg$e22 = peg$literalExpectation("{", false);
  const peg$e23 = peg$literalExpectation("}", false);
  const peg$e24 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", "$"], false, false, false);
  const peg$e25 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", ["0", "9"], "-", ":"], false, false, false);
  ...
  const peg$e33 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", ["0", "9"]], false, false, false);
  ...
  const peg$e46 = peg$otherExpectation("arrow function attribute value");
  const peg$e47 = peg$literalExpectation(";", false);
  const peg$e48 = peg$literalExpectation("function", false);
  const peg$e49 = peg$literalExpectation("@else", false);
  const peg$e50 = peg$literalExpectation("@endif", false);
  const peg$e51 = peg$literalExpectation("@endeach", false);
  ...
  const peg$e78 = peg$literalExpectation("typeof", false);
  const peg$e79 = peg$literalExpectation("void", false);
  const peg$e80 = peg$literalExpectation("delete", false);
  const peg$e81 = peg$classExpectation([["0", "9"]], false, false, false);
  const peg$e82 = peg$literalExpectation("'", false);
  const peg$e83 = peg$classExpectation(["'"], true, false, false);
  ...
  const peg$e87 = peg$literalExpectation("undefined", false);
  ...
  function peg$f4(rawHtml) {    return rawHtml;  }
  function peg$f5(openTag, innerContent, closeTag) {
  ...
  function peg$f11(attributes, content) {
    const loc = location();
    return {
      type: "RawHTMLBlock",
      name: "pre",
  ...
  function peg$f46(parts) {    // Changed to ConsequentContentBlock
  ...
  function peg$f47(text) {    // Removed leading/trailing _ (optional whitespace) as the content itself can include space.
  ...
  function peg$f48(expr) {    // Removed leading and trailing `_`
         return {
           type: 'MustacheTag',
           expression: expr,
           start: location().start,
  ...
  function peg$f49(test, consequent, alternate) {
    return createConditionalExpression(test, consequent, alternate);
  }
  function peg$f50(left, right) {    return createBinaryExpression(left, "||", right);  }
  ...
  function peg$f53(left, op, right) {
    return createBinaryExpression(left, op, right);
  }
  function peg$f54(left, op, right) {    return createBinaryExpression(left, op, right);  }
  ...
  function peg$f70(chars) {    // Add action block here
         return createNode('Literal', location().start, location().end, {
           value: chars,
