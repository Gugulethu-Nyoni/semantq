...
function peg$parse(input, options) {
  ...
  const peg$c69 = "void";
  const peg$c70 = "delete";
  const peg$c71 = "'";
  const peg$c72 = "true";
  const peg$c73 = "false";
  const peg$c74 = "null";
  const peg$c75 = "undefined";
  const peg$c76 = "as";
  ...
  const peg$e4 = peg$literalExpectation("@each", false);
  const peg$e5 = peg$anyExpectation();
  const peg$e6 = peg$literalExpectation("@else", false);
  const peg$e7 = peg$literalExpectation("@endif", false);
  const peg$e8 = peg$literalExpectation("@endeach", false);
  const peg$e9 = peg$literalExpectation("&", false);
  const peg$e10 = peg$literalExpectation(";", false);
  const peg$e11 = peg$literalExpectation("copy", false);
  const peg$e12 = peg$literalExpectation("amp", false);
  const peg$e13 = peg$literalExpectation("lt", false);
  const peg$e14 = peg$literalExpectation("gt", false);
  const peg$e15 = peg$literalExpectation("nbsp", false);
  const peg$e16 = peg$literalExpectation("quot", false);
  ...
  const peg$e27 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"]], false, false, false);
  const peg$e28 = peg$otherExpectation("pre block");
  const peg$e29 = peg$literalExpectation("pre", false);
  const peg$e30 = peg$literalExpectation("</pre>", false);
  const peg$e31 = peg$otherExpectation("code block");
  const peg$e32 = peg$literalExpectation("code", false);
  const peg$e33 = peg$literalExpectation("</code>", false);
  const peg$e34 = peg$literalExpectation("=", false);
  const peg$e35 = peg$otherExpectation("two-way binding attribute");
  const peg$e36 = peg$literalExpectation("bind:", false);
  ...
  const peg$e41 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", ["0", "9"], "-", ":"], false, false, false);
  ...
  const peg$e50 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", ["0", "9"]], false, false, false);
  ...
  const peg$e63 = peg$otherExpectation("arrow function attribute value");
  const peg$e64 = peg$literalExpectation("function", false);
  ...
  const peg$e91 = peg$literalExpectation("typeof", false);
  const peg$e92 = peg$literalExpectation("void", false);
  const peg$e93 = peg$literalExpectation("delete", false);
  const peg$e94 = peg$literalExpectation("'", false);
  const peg$e95 = peg$classExpectation(["'"], true, false, false);
  const peg$e96 = peg$literalExpectation("true", false);
  const peg$e97 = peg$literalExpectation("false", false);
  const peg$e98 = peg$literalExpectation("null", false);
  const peg$e99 = peg$literalExpectation("undefined", false);
  ...
  const peg$e102 = peg$literalExpectation("as", false);

  function peg$f0(chars) {
    const loc = location();
    return {
      type: 'TextNode',
      value: chars,
  ...
  function peg$f1(text) {
    ...
    return {
      type: 'TextNode',
      value: text, // No .replace() here; entities are handled by the HTMLEntity sibling
      raw: text,
      start: loc.start.offset,
      end: loc.end.offset,
      loc: {
  ...
  function peg$f9(d) {    return String.fromCodePoint(parseInt(d, 10));  }
  function peg$f10(h) {    return String.fromCodePoint(parseInt(h, 16));  }
  ...
  function peg$f14(rawHtml) {    return rawHtml;  }
  function peg$f15(openTag, innerContent, closeTag) {
  ...
  function peg$f20(name) {    return name;  }
  function peg$f21(attributes, content) {
    const loc = location();
    return {
      type: "RawHTMLBlock",
      name: "pre",
  ...
  function peg$f22(attributes, content) {
    const loc = location();
    return {
      type: "RawHTMLBlock",
      name: "code",
  ...
  function peg$f25(propertyName, value) {
  ...
  function peg$f27(name, contents) {
  ...
  function peg$f34(text) {
    // Capture text that is NOT the start of an @if(, mustache tag, or the closing quote "
    return {
     type: 'TextNode',
     value: text,
     raw: text,
  ...
  function peg$f38(head, param) {    return param;  }
  ...
  function peg$f44(left, operator, right) {
    return {
  ...
  function peg$f46(params) {    return params || [];  }
  function peg$f47(param) {    return [param];  }
  function peg$f48(head, tail) {
    return [head, ...tail.map(t => t[3])];
  }
  function peg$f49(params, body) {
    return createArrowFunction(params, body);
  }
  function peg$f50(arrowExpr) {
    return {
      type: "MustacheAttribute",
      start: location().start.offset,
      end: location().end.offset,
  ...
  function peg$f51(statements) {
    return {
      type: "BlockStatement",
      body: statements
    };
  }
  function peg$f52(expression) {
    return {
      type: "ExpressionStatement",
      expression: expression
    };
  }
  function peg$f53(params, Identifier, parameters) {
    return {
      type: "IIFE",
      start: location().start.offset + 1,
      end: location().end.offset - 1,
  ...
  function peg$f55(startToken, test, consequent, elsePart) {
  ...
  function peg$f57(content) {
    return content;
  }
  function peg$f58(parts) {    // Changed to ConsequentContentBlock
  ...
  function peg$f59(text) {    // Removed leading/trailing _ (optional whitespace) as the content itself can include space.
  ...
  function peg$f60(expr) {    // Removed leading and trailing `_`
         return {
           type: 'MustacheTag',
           expression: expr,
           start: location().start,
  ...
  function peg$f62(left, right) {    return createBinaryExpression(left, "||", right);  }
  function peg$f63(left, right) {    return createBinaryExpression(left, "??", right);  }
  function peg$f64(left, right) {    return createBinaryExpression(left, "&&", right);  }
  function peg$f65(left, op, right) {
    return createBinaryExpression(left, op, right);
  }
  function peg$f66(left, op, right) {    return createBinaryExpression(left, op, right);  }
  function peg$f67(left, op, right) {    return createBinaryExpression(left, op, right);  }
  function peg$f68(left, op, right) {    return createBinaryExpression(left, op, right);  }
  function peg$f69(left, op, right) {
    return createBinaryExpression(left, op, right);
  }
  function peg$f70(operator, argument) {    // <-- Change to LeftHandSideExpression
         return createUpdateExpression(operator, argument, true, location().start.offset, argument.end);
  }
  function peg$f71(argument, operator) {    // <-- Change to LeftHandSideExpression
         return createUpdateExpression(operator, argument, false, argument.start, location().end.offset);
  }
  function peg$f72() {    return expr;  }
  function peg$f73(expr) {    return expr;  }
  function peg$f74(callee, args) {
  ...
  function peg$f76(op, argument) {    // FIXED
  ...
  function peg$f82(chars) {    // Add action block here
         return createNode('Literal', location().start, location().end, {
           value: chars,
  ...
  function peg$parseHTMLEntity() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parseNamedEntity();
      if (s2 === peg$FAILED) {
        s2 = peg$parseNumericEntity();
        if (s2 === peg$FAILED) {
          s2 = peg$parseHexEntity();
        }
      }
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseNumericEntity() {
    let s0, s1, s2, s3, s4;
