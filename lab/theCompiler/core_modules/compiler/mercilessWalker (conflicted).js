...
function deepWalker(ast, nodeType = null, matchLogic, returnType = null) {
    ...
    console.log(ast, nodeType, matchLogic, returnType);

    function _deepWalk(ast, nodeType, matchLogic, returnType) {
        console.log(ast, nodeType, matchLogic, returnType);
    }

    _deepWalk(ast, nodeType, matchLogic, returnType);
}
...
const returnType = 'nodeValueName'; 
const matchLogic = (node,nodeType) => node.type === nodeType;

deepWalker(ast, nodeType, matchLogic, returnType);
