...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c2 = function(jsCode) { return { type: "script", content: jsCode || "" }; },
      peg$c3 = peg$anyExpectation(),
      peg$c4 = function(jsCode) { return { type: "code", content: trimWhitespace(jsCode) }; },
      peg$c5 = /^[ \t\r\n]/,
  ...
  function peg$parseline() {
    ...
    s0 = peg$parsescriptLine();
    if (s0 === peg$FAILED) {
      s0 = peg$parsejsCodeLine();
      if (s0 === peg$FAILED) {
