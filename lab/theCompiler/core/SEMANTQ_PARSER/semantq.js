...
function peg$parse(input, options) {
  ...
  var peg$e48 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", ["0", "9"], "-"], false, false);
  ...
  var peg$f41 = function(name, params) {
  return {
  ...
  var peg$f43 = function(head, param) { return param; };
  ...
  var peg$f47 = function(identifier, params) {
  return {
  ...
  var peg$f48 = function(params, Identifier, parameters) {
  return {
    type: "IIFE",
    start: location().start.offset + 1,
    end: location().end.offset - 1,
  ...
  var peg$f49 = function(fragment) { return fragment; };
  ...
  var peg$f53 = function(condition, trueValue, falseValue) {
  ...
  var peg$f54 = function(condition) {
