...
function peg$parse(input, options) {
  ...
  var peg$f39 = function(name, params) {
  return {
  ...
  var peg$f41 = function(head, param) { return param; };
  ...
  var peg$f45 = function(identifier, params) {
  return {
  ...
  var peg$f46 = function(params, Identifier, parameters) {
  return {
    type: "IIFE",
    start: location().start.offset + 1,
    end: location().end.offset - 1,
  ...
  var peg$f47 = function(fragment) { return fragment; };
  var peg$f48 = function(text) {
      const loc = location();
      return createTextNode(text, loc.start, loc.end);
    };
  var peg$f49 = function(condition, trueValue, falseValue) {
  ...
  var peg$f50 = function(condition) {
