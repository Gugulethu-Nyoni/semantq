...
function peg$parse(input, options) {
  ...
  const peg$c52 = ".";
  const peg$c53 = "?.";
  const peg$c54 = "typeof";
  const peg$c55 = "void";
  const peg$c56 = "delete";
  const peg$c57 = "'";
  const peg$c58 = "true";
  const peg$c59 = "false";
  const peg$c60 = "null";
  const peg$c61 = "undefined";
  const peg$c62 = "@each";
  const peg$c63 = "@endeach";
  const peg$c64 = "as";
  ...
  const peg$e72 = peg$literalExpectation("typeof", false);
  const peg$e73 = peg$literalExpectation("void", false);
  const peg$e74 = peg$literalExpectation("delete", false);
  const peg$e75 = peg$classExpectation([["0", "9"]], false, false, false);
  const peg$e76 = peg$literalExpectation("'", false);
  const peg$e77 = peg$classExpectation(["'"], true, false, false);
  const peg$e78 = peg$literalExpectation("true", false);
  const peg$e79 = peg$literalExpectation("false", false);
  const peg$e80 = peg$literalExpectation("null", false);
  const peg$e81 = peg$literalExpectation("undefined", false);
  const peg$e82 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, false, false);
  const peg$e83 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_"], false, false, false);
  const peg$e84 = peg$literalExpectation("@each", false);
  const peg$e85 = peg$literalExpectation("@endeach", false);
  const peg$e86 = peg$literalExpectation("as", false);
