...
//const contentMatch = sourceCode.match(/(?<![\w-])content:\s*\n*([\s\S]*?)(?=script:|style:|$)/);
//const contentMatch = sourceCode.match(/(?<![\w-])content:\s*\n*([^]*?)(?=script:|style:|$)/);
//const contentMatch = sourceCode.match(/(?<=style:\s*\n*[\s\S]*?)content:\s*\n*([^]*?)(?=script:|style:|$)/);
//const contentMatch = sourceCode.match(/content:\s*\n*([\s\S]*?)(?=script:|style:|$)(?![\s\S]*?style:)/);
//const contentMatch = sourceCode.match(/style:\s*([\s\S]*?)content:\s*\n*([\s\S]*?)(?=script:|style:|$)/);
//const contentMatch = sourceCode.match(/^content::\s*\n*([^]*?)(?=script:|style:|$)/gm);
//const contentMatch = sourceCode.match(/content(?!-\w+:s)/g);
const contentMatch = sourceCode.match(/^content:\s*\n*([\s\S]*)(?=script:|style:|$)/m);
